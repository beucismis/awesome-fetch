...
- [wretch](https://github.com/thesillyboi/wretch) - This is my fetch script written in Rust, as one of my first projects. `Rust`
...
- [neofetch68k](https://www.cemetech.net/downloads/files/2664/x3443) - Neofetch clone for TI calculators that run the Advanced Mathematics Software OS. `Unkown`
...
- [gitfetch](https://github.com/Matars/gitfetch) - A neofetch alternative for GitHub quick view. `Python`
...
- [songfetch](https://github.com/ekrlstd/songfetch) - A Linux CLI tool, very similar to neofetch, that displays current song information in the terminal. `Python`
